$_mod.def("/marko$4.18.14/dist/runtime/components/Component", function(require, exports, module, __filename, __dirname) { "use strict";
/* jshint newcap:false */

var complain;

var domInsert = require('/marko$4.18.14/dist/runtime/dom-insert'/*"../dom-insert"*/);
var defaultCreateOut = require('/marko$4.18.14/dist/runtime/createOut'/*"../createOut"*/);
var getComponentsContext = require('/marko$4.18.14/dist/runtime/components/ComponentsContext'/*"./ComponentsContext"*/).D_;
var componentsUtil = require('/marko$4.18.14/dist/runtime/components/util-browser'/*"./util"*/);
...
var RenderResult = require('/marko$4.18.14/dist/runtime/RenderResult'/*"../RenderResult"*/);
...
var updateManager = require('/marko$4.18.14/dist/runtime/components/update-manager'/*"./update-manager"*/);
var morphdom = require('/marko$4.18.14/dist/runtime/vdom/morphdom/index'/*"../vdom/morphdom"*/);
var eventDelegation = require('/marko$4.18.14/dist/runtime/components/event-delegation'/*"./event-delegation"*/);
var domData = require('/marko$4.18.14/dist/runtime/components/dom-data'/*"./dom-data"*/);
