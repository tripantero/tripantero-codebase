$_mod.def("/marko$4.18.14/dist/runtime/components/renderer", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.18.14/dist/runtime/components/util-browser'/*"./util"*/);
var componentLookup = componentsUtil.h_;
var emitLifecycleEvent = componentsUtil.E_;

var ComponentsContext = require('/marko$4.18.14/dist/runtime/components/ComponentsContext'/*"./ComponentsContext"*/);
...
var beginComponent = require('/marko$4.18.14/dist/runtime/components/beginComponent-browser'/*"./beginComponent"*/);
var endComponent = require('/marko$4.18.14/dist/runtime/components/endComponent-browser'/*"./endComponent"*/);
