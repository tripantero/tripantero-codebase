$_mod.def("/marko$4.18.14/dist/runtime/components/ComponentDef", function(require, exports, module, __filename, __dirname) { "use strict";

var complain;
var componentUtil = require('/marko$4.18.14/dist/runtime/components/util-browser'/*"./util"*/);
var attachBubblingEvent = componentUtil._y_;
var addDelegatedEventHandler = require('/marko$4.18.14/dist/runtime/components/event-delegation'/*"./event-delegation"*/)._z_;
var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
var KeySequence = require('/marko$4.18.14/dist/runtime/components/KeySequence'/*"./KeySequence"*/);
