$_mod.def("/marko$4.18.14/dist/runtime/vdom/morphdom/index", function(require, exports, module, __filename, __dirname) { "use strict";

var specialElHandlers = require('/marko$4.18.14/dist/runtime/vdom/morphdom/specialElHandlers'/*"./specialElHandlers"*/);
var componentsUtil = require('/marko$4.18.14/dist/runtime/components/util-browser'/*"../../components/util"*/);
...
var VElement = require('/marko$4.18.14/dist/runtime/vdom/vdom'/*"../vdom"*/).aT_;
var virtualizeElement = VElement.bI_;
var morphAttrs = VElement.bJ_;
var eventDelegation = require('/marko$4.18.14/dist/runtime/components/event-delegation'/*"../../components/event-delegation"*/);
var fragment = require('/marko$4.18.14/dist/runtime/vdom/morphdom/fragment'/*"./fragment"*/);
var helpers = require('/marko$4.18.14/dist/runtime/vdom/morphdom/helpers'/*"./helpers"*/);
var domData = require('/marko$4.18.14/dist/runtime/components/dom-data'/*"../../components/dom-data"*/);
