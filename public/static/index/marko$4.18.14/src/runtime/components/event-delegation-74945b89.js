$_mod.def("/marko$4.18.14/src/runtime/components/event-delegation", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.18.14/src/runtime/components/util-browser'/*"./util"*/);
